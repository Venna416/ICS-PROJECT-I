    ...
    <div class="flex justify-center items-center min-h-screen bg-gradient-to-br from-pink-400 via-purple-500 to-blue-400">
        ...
        <div class="bg-white/90 p-8 rounded-xl shadow-2xl w-full max-w-lg">
            ...
            <form action="{{ route('buyer.profile.update', $profile->id) }}" method="POST">
                ...
                <div class="mb-4">
                    <label class="block text-blue-900 mb-2 font-semibold">
                        Email
                    </label>
                ...
                <div class="flex justify-between">
                    ...
                    <a href="{{ route('buyer.profile.show', $profile->id) }}"
                        class="bg-gray-500 hover:bg-gray-600 text-white font-bold py-2 px-6 rounded-lg shadow-md transition duration-200">
                        Cancel
                    </a>
            ...
            {{-- Delete Form --}}
            <form action="{{ route('buyer.profile.destroy', $profile->id) }}" method="POST" class="mt-6"
                ...
                <button type="submit"
                    class="w-full bg-pink-500 hover:bg-pink-600 text-white font-bold py-2 px-6 rounded-lg shadow-md transition duration-200">
                    🗑️ Delete Profile
                </button>
