...
<body class="bg-gray-50 text-gray-900 font-sans antialiased min-h-screen flex flex-col">
    ...
    <section class="bg-[#0a2540] text-white py-12 px-6">
        <div class="max-w-4xl mx-auto text-center space-y-4">
            ...
            <p class="text-sm text-slate-300 max-w-lg mx-auto">Verify corporate credentials, physical operational
                footprints, and individual trust profiles instantly.</p>
        ...
        @if (!empty($search))
            <div class="mb-8 border-b border-gray-200 pb-4">
                <p class="text-sm text-gray-500">
                    ...
                    <span class="ml-2 text-xs text-gray-400">({{ $sellers->count() }} results found)</span>
                </p>
            </div>
        @endif
                        ...
                        <div class="p-6 flex-grow space-y-4">
                            ...
                            <div class="space-y-2 text-xs text-gray-500">
                                ...
                                @if ($seller->shop_link)
                                    <div class="flex items-center gap-2">
                                        <span class="text-slate-400 w-4 text-center">🔗</span>
                                        <a href="{{ $seller->shop_link }}" target="_blank"
