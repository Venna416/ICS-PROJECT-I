...
<body class="bg-gray-50 text-gray-900 font-sans antialiased">
        ...
        <div class="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center gap-8">
            ...
            <div class="flex items-center space-x-3 shrink-0">
                ...
                <div>
                    ...
                    <p class="text-[10px] text-slate-500 font-semibold tracking-wider uppercase mt-0.5">Online Seller Verification System</p>
                </div>
            </div>
    ...
    <section id="features" class="py-24 max-w-7xl mx-auto px-6">
        ...
        <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div class="bg-white p-8 rounded-2xl border border-gray-100 shadow-sm text-center space-y-4 hover:shadow-md transition-all group">
                <div class="w-14 h-14 mx-auto rounded-2xl bg-blue-50 text-blue-600 flex items-center justify-center shadow-inner group-hover:bg-blue-600 group-hover:text-white transition-all p-3">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="w-7 h-7">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M9 12.75L11.25 15 15 9.75m-3-7.036A11.959 11.959 0 013.598 6 11.99 11.99 0 003 9.749c0 5.592 3.824 10.29 9 11.623 5.176-1.332 9-6.03 9-11.622 0-1.31-.21-2.571-.598-3.751h-.152c-3.196 0-6.1-1.242-8.651-3.011z" />
                    </svg>
                </div>
                <h3 class="text-lg font-bold text-[#0a2540]">Seller Verification</h3>
                <p class="text-sm text-gray-500 leading-relaxed">We verify seller identities using multiple verification checks to ensure legitimacy.</p>
            </div>

            <div class="bg-white p-8 rounded-2xl border border-gray-100 shadow-sm text-center space-y-4 hover:shadow-md transition-all group">
                <div class="w-14 h-14 mx-auto rounded-2xl bg-blue-50 text-blue-600 flex items-center justify-center shadow-inner group-hover:bg-blue-600 group-hover:text-white transition-all p-3">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="w-7 h-7">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M11.48 3.499c.172-.435.741-.435.913 0l2.11 5.32 5.762.392c.477.032.668.62.316.942l-4.322 3.96 1.434 5.642c.119.467-.393.839-.783.565l-4.942-3.477-4.942 3.477c-.39.274-.902-.098-.783-.565l1.434-5.642-4.322-3.96c-.352-.321-.161-.91.316-.942l5.762-.392 2.11-5.32z" />
                    </svg>
                </div>
                <h3 class="text-lg font-bold text-[#0a2540]">Trust Scores</h3>
                <p class="text-sm text-gray-500 leading-relaxed">Get an instant overview of seller credibility through detailed trust scores and risk levels.</p>
            </div>

            <div class="bg-white p-8 rounded-2xl border border-gray-100 shadow-sm text-center space-y-4 hover:shadow-md transition-all group">
                <div class="w-14 h-14 mx-auto rounded-2xl bg-red-50 text-red-500 flex items-center justify-center shadow-inner group-hover:bg-red-500 group-hover:text-white transition-all p-3">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="w-7 h-7">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M12 9v3.75m-9.303 3.376c-.866 1.5.217 3.374 1.948 3.374h14.71c1.73 0 2.813-1.874 1.948-3.374L13.949 3.378c-.866-1.5-3.032-1.5-3.898 0L2.697 16.126zM12 15.75h.007v.008H12v-.008z" />
                    </svg>
                </div>
                <h3 class="text-lg font-bold text-[#0a2540]">Fraud Reporting</h3>
                <p class="text-sm text-gray-500 leading-relaxed">Report suspicious activities and potential scams to help protect other buyers.</p>
            </div>

            <div class="bg-white p-8 rounded-2xl border border-gray-100 shadow-sm text-center space-y-4 hover:shadow-md transition-all group">
                <div class="w-14 h-14 mx-auto rounded-2xl bg-emerald-50 text-emerald-600 flex items-center justify-center shadow-inner group-hover:bg-emerald-600 group-hover:text-white transition-all p-3">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="w-7 h-7">
                ...
                <p class="text-sm text-gray-500 leading-relaxed">View comprehensive risk analysis before making any purchase decisions.</p>
            </div>

        </div>
    </section>

    <section id="how-it-works" class="bg-blue-50/50 border-y border-blue-100/50 py-20">
        <div class="max-w-7xl mx-auto px-6">
            ...
            <div class="relative grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
                <div class="hidden lg:block absolute top-7 left-10 right-10 h-0.5 border-t-2 border-dashed border-blue-200 z-0"></div>

                <div class="text-center space-y-3 relative z-10">
                    <div class="w-14 h-14 mx-auto rounded-full bg-blue-600 text-white flex items-center justify-center shadow-lg shadow-blue-600/20 p-3">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2.5" stroke="currentColor" class="w-6 h-6">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M21 21l-5.197-5.197m0 0A7.5 7.5 0 105.196 5.196a7.5 7.5 0 0010.607 10.607z" />
                        </svg>
                    </div>
                    <h4 class="font-bold text-gray-900">1. Search</h4>
                    <p class="text-xs text-gray-500 leading-relaxed max-w-xs mx-auto">Search for any seller by name, category or location.</p>
                </div>
                ...
                <div class="text-center space-y-3 relative z-10">
                    ...
                    <p class="text-xs text-gray-500 leading-relaxed max-w-xs mx-auto">View verification status, trust score and risk level.</p>
                </div>
                ...
                <div class="text-center space-y-3 relative z-10">
                    ...
                    <p class="text-xs text-gray-500 leading-relaxed max-w-xs mx-auto">Read buyer reviews and experiences shared.</p>
                </div>
                ...
                <div class="text-center space-y-3 relative z-10">
                    ...
                    <p class="text-xs text-gray-500 leading-relaxed max-w-xs mx-auto">Make informed decisions and shop with confidence.</p>
                </div>
    ...
    <section id="about" class="max-w-7xl mx-auto px-6 py-16">
        <div class="bg-gradient-to-r from-[#06182c] to-[#0b2b4d] rounded-2xl p-8 sm:p-12 flex flex-col md:flex-row justify-between items-center gap-8 relative overflow-hidden shadow-xl border border-slate-800">
            <div class="flex items-center space-x-6 z-10">
                ...
                <div class="space-y-2">
                    ...
                    <p class="text-sm text-slate-300 max-w-md">Join OSVS today and help build a trusted and secure online shopping community.</p>
                </div>
            </div>
    ...
    <footer id="contact" class="bg-[#061324] text-slate-400 text-sm">
        <div class="max-w-7xl mx-auto px-6 py-16 grid grid-cols-1 md:grid-cols-12 gap-10">
            ...
            <div class="md:col-span-4 space-y-4">
                ...
                <p class="text-xs leading-relaxed text-slate-400">Our mission is to create a safe and transparent online marketplace for buyers and sellers.</p>
            ...
            <div class="md:col-span-4 space-y-3">
                ...
                <ul class="space-y-2 text-xs text-slate-400">
                    <li class="flex items-center gap-2">✉️ onlinesellers@email.com</li>
                    <li class="flex items-center gap-2">📞 +254 70651132</li>
        ...
        <div class="border-t border-slate-800 py-6 max-w-7xl mx-auto px-6 flex justify-center items-center text-xs text-slate-500">
